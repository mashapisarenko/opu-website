...
<p>Within two weeks, an adult working sensibly is playing short pieces with one hand and beginning to put hands together. It will be simple, and it will sound like music rather than like exercises. Method books are engineered for this, and they are good at it.</p>

<p>The trap here is that the first two weeks goes better than people expect, which sets up the month-three disappointment. Nothing has gone wrong at month three. The easy part simply ended.</p>

<h2>Month three: recognizable tunes, hands together</h2>
